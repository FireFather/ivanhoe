...
// 'function' : 'unsigned long *' differs in indirection to slightly different base types from 'int *'
#pragma warning(disable : 4244)
// '=' : conversion from 'int' to 'uint8', possible loss of data
